    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('FR', 'Freelancer'), ('CL', 'Client'), ('AD', 'Admin')], default='FR', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user'], name='users_profi_user_id_783607_idx'), models.Index(fields=['location'], name='users_profi_locatio_d9577c_idx'), models.Index(fields=['hourly_rate'], name='users_profi_hourly__695cb8_idx')],
            },
        ),
        migrations.CreateModel(
            name='UserRating',
            fields=[
                ...
                ('quality_rating', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
                ('timeliness_rating', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
                ('comment', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings_given', to='users.user')),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings_received', to='users.user')),
            ],
            options={
